...
| ------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2 — Git & GitHub                      | Umfangreichste Einzelstufe der Spec (2 eigene Labs: Git-Simulator, Merge-Conflict). In der Master-Spec als "extrem wichtig" markiert — nächster sinnvoller Schritt für Runde 2, nicht in dieser Runde neben LLM/Prompting zu leisten, ohne Qualität zu verlieren. |
...
2. **Stufe 2 (Git & GitHub).** Größter fachlicher Hebel: Voraussetzung für
